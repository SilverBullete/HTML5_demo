    ...
    <!-- <div class="king-page-topbar pl20 pr20 "> -->
        <div class="king-page-topbar ">
            ...
            <ul class="breadcrumb king-breadcrumb pl0 bg-transparent">
                ...
                <li><a href="/thirdStep">植被提取</a></li>
                <li class="active"><a href="/fourthStep">滑坡提取</a></li>
            </ul>
        </div>
        <!-- 面板 编辑 开始 -->
        <!-- 面板 编辑 结束 -->
        <div class="king-block king-block-bordered king-block-themed mb0">
            <div class="king-block-header king-gray-dark">
                ...
                <h3 class="king-block-title">第四步 滑坡提取</h3>
            </div>
            <div class="king-block-content">
                <form class="form-horizontal" method="POST" style="padding-left: 14%;padding-right: 14%">
                    <div class="form-group">
                        <label for="inputThreshold" class="col-sm-3 control-label">滑坡提取阈值：</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="inputThreshold" placeholder="">
                        </div>
                    </div>
                    <div class="buttons" style="float: right">
                        <a class="king-btn-demo king-btn king-round king-default king-disabled" title="完成并下载" id="button_finish">完成</a>
...
<script>
    function isReady() {
        var classList = document.getElementById("button_finish").classList;
        var bool = true;
    ...
    function next() {
        ...
        if (threshold != ""){
            document.getElementById("button_finish").classList.remove("king-disabled");
        }
        else{
            bool = isReady();
            if (bool){
                document.getElementById("button_finish").classList.add("king-disabled");
            }
        }
    }
    ...
    function my_post() {
        var url = "http://47.100.193.191:8080/api/landsideController/";
                ...
                if (JSON.parse(res)['code'] == 200){
                    ...
                    if (isReady()){
                        ...
                        if (JSON.parse(res)['code'] !=200){
                            ...
                            var fname = (files.split('.')).join("_result.");
