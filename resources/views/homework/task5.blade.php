            ...
            <div class="king-layout1-content" style="margin-left: 216px;">
                <div class="container-fluid mb0 ">
                    <div class="row" style="margin-left: 10px; margin-top: 5px">
                        <div class="head"><h1>上机练习5</h1></div>
                        <div class="body">
                            <div class="left">
                                <h2>问候</h2>
                                <p>点击这个按钮，获得基于时间的问候。</p>
                                <input type="button" value="点击这里" onclick="getDate()">
                                <p id="date"></p>
                            </div>
                            <div class="center">
                                <h2>数组</h2>
                            ...
                            <div class="right">
                                <h2>星期</h2>
                                <p>点击下面的按钮来显示今天是周几：</p>
                                <input type="button" value="点击这里" onclick="showWeek()">
                                <p id="week"></p>
                            </div>
                        </div>
                        <script>
                            function getDate() {
                                ...
                                if (myDate.getHours() < 10) {
                                    document.getElementById('date').innerHTML = "早上好";
                                }
                                else if (myDate.getHours() < 20) {
                                    document.getElementById('date').innerHTML = "你好";
                                }
                                else {
                                    document.getElementById('date').innerHTML = "晚上好";
                                }
                            }

                            function showArray() {
                                var myArray = new Array("Python", "C++", "JavaScript", "C", "VB", "Java");
                                var p = document.getElementById('array');
                                for (var i = 0; i < myArray.length; i++) {
                                    var d = document.createElement('p');
                                    d.innerText = myArray[i];
                                    p.appendChild(d);
                                }
                            }
                            ...
                            function showWeek() {
                                ...
                                document.getElementById('week').innerHTML="今天是周"+arr[myDate.getDay()]
                            }
